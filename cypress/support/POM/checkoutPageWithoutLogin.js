class CheckoutPageWithoutLogin {
  // ═══════════════════════════════════════════════
  // ELEMENTS (Selectors)
  // ═══════════════════════════════════════════════
  ...
  // Checkout Page - Contact Information (Email)
  get emailField() {
  ...
  // Add Product to Cart Flow (without login)
  ...
  verifyProductAddedToCart() {
    cy.get(".shopping-cart-icon").should("be.visible");
  }
  ...
  verifyPlaceOrderButtonShowsSelectPayment() {
    cy.get(".checkout-button-section.mt-6").should("be.visible");
  }
...
export default CheckoutPageWithoutLogin;
